...
public final class LogUtils {
    ...
    public static String readableFileSize(final long size) {
        ...
        return new DecimalFormat("#,##0.#").format(size / Math.pow(1024.0, (double) digitGroups)) + ' ' + units[digitGroups];
    }
