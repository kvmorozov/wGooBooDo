...
object ArchiveConstants {
    ...
    const val ARCHIVE_IMG_TEMPLATE = "https://%SERVER%/BookReader/BookReaderImages.php?zip=%ITEM_PATH%/%BOOK_ID%_jp2.zip&file=%BOOK_ID%_jp2/%BOOK_ID%_%PID%.jp2&scale=4&rotate=0"
